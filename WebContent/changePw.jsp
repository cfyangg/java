...
<html lang="en">
	...
	<body>
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li><a href="servlet/UserServlet?op=listOrders">查看订单</a></li>
		...
		<div class="section">
			...
			<div class="container">
				<!-- row -->
				<div class="row" >
				<form action="servlet/UserServlet?op=oldPw" method="post">
    ...
    <div class="form-group">
      ...
      <input type="password" class="form-control" id="password" placeholder="new Password" name="newp">
    </div>
    <div align="center">

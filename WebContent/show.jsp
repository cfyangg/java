...
<%
	Books sb=(Books)session.getAttribute("showbook");
	List<BookComment> comment=(List<BookComment>)session.getAttribute("comment");
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active"><%=sb.getTitle() %></li>
						</ul>
					</div>
				</div>
				<!-- /row -->
				...
				<div class="row">
					...
					<div class="col-md-5" >
						<div class="product-details">
							<h2 class="product-name"><%=sb.getTitle() %></h2>
							<div>
								...
								<a class="review-link" href="#"><%=comment.size() %> Review(s) | Add your review</a>
							</div>
							<div>
								<h3 class="product-price"><%=sb.getUnitPrice() %></h3>
								...
								<span class="product-available">简介</span>
							</div>
							<p><%=sb.getContentDescription() %></p>
							<form action="${pageContext.request.contextPath}/servlet/UserServlet?op=addcart" method="post">
							<div class="form-group">
								<label>
									数量
									<input class="form-control" id="count" placeholder="Enter need count" name="count">
								</label>
					...
					<div class="col-md-12">
						<div id="product-tab">
							<!-- product tab nav -->
							<ul class="tab-nav">
								<li class="active"><a data-toggle="tab" href="#tab1">作者简介</a></li>
								<li><a data-toggle="tab" href="#tab2">编辑评语</a></li>
								<li><a data-toggle="tab" href="#tab3">目录</a></li>
								<li><a data-toggle="tab" href="#tab4">评论</a></li>
							...
							<div class="tab-content">
								...
								<div id="tab3" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12" style='border:0px;padding:3px; PADDING:0px; width:1180px; height:450px; LINE-HEIGHT: 20px; OVERFLOW: auto; '>
											<p><%=sb.getTOC() %></p>
										</div>
									</div>
								</div>
								...
								<div id="tab4" class="tab-pane fade in">
									<div class="row">										
										<!-- Reviews -->
										<div class="col-md-6" style='border:0px;padding:3px; PADDING:0px; width:800px; height:400px; LINE-HEIGHT: 20px; OVERFLOW: auto; '>
											<div id="reviews">
											<%
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">用户<%=comment.get(i).getId() %></h5>
															<p class="date"><%=comment.get(i).getCreateDateTime() %></p>													
														</div>
														<div class="review-body">
															<p><%=comment.get(i).getMsg() %></p>
														</div>
													</li>																							
												</ul>	
											<%
										...
										<div class="col-md-3">
											<div id="review-form">
												<form class="review-form" action="${pageContext.request.contextPath}/servlet/UserServlet?op=addcomment" method="post">
													<textarea class="input" name="input" placeholder="Input Your Review"></textarea>													

...
<head>
	...
	<div class="container">	
    <form action="${pageContext.request.contextPath}/servlet/ValidateEmail?op=userRegist" method="post">
      ...
      <input type="text" class="form-control" id="password" name="Mail">
    			
    				
    				<button type="submit" class="primary-btn">发送验证码</button>
